...
Algoritmo Estacion_del_año_segun_mes
	...
	Segun Mes Hacer
		...
		3: Escribir "En Marzo es Primavera"
		4: Escribir "En Abril es Primavera"
		5: Escribir "En Mayo es Primavera"
		6: Escribir "En Junio es Verano"
		7: Escribir "En Julio es Verano"
		8: Escribir "En Agosto es Verano"
		9: Escribir "En Septiembre es Otoño"
		10: Escribir "En Octubre es Otoño"
		11: Escribir "En Noviembre es Otoño"
		12: Escribir "En Diciembre es Invierno"
		De Otro Modo:
			Escribir "Valor no reconocido"
